...
const BadCreditDes = document.getElementById('BadCreditDes');
...
function updateBlog(language) {
    if (language === 'bm') {
        ...
        GettingALoan.textContent = 'Ingin Memohon Pinjaman? Tingkatkan Peluang Anda Untuk Dapat Kelulusan Pinjaman!n';
        ...
        BadCreditDes.textContent = 'Jika anda pernah memohon pinjaman di mana-mana institusi kewangan perbankan atau bukan bank, anda ...';
    } else {
        ...
        BadCredit.textContent = 'BAD CREDIT SCORE? Here’s how to improve your CTOS & CCRIS';
        BadCreditDes.textContent = 'If you have applied for loans at any banking or non-banking financial institutions, chances are you might...';
    }
}
